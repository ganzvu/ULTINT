import sys
import cmd2
from core.ig.core.models import User
from core.ig.api.client import InstagramClient
from core.ig.modules.recon import ReconEngine
from core.ig.modules.analytics import AnalyticsEngine
from core.ig.modules.surveillance import SurveillanceEngine
from core.ig.modules.exporter import DataExporter
from core.ig.cli.formatters import console, print_splash, print_user_info, print_action_menu
...
class IGDetectiveShell(cmd2.Cmd):
    ...
    def do_surveillance(self, args):
        ...
        import time
        from core.ig.modules.evasion import poisson_jitter
